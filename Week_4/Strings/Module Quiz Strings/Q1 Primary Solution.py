...
def is_palindrome(input_string):
    ...
    for letter in input_string.lower():
        ...
        # of the other string. 
        if letter.isalpha(): #only takes value if alphanumeric, ignores white_spaces
            new_string = new_string + letter #storing in regular order
            reverse_string = letter + reverse_string #storing in reverse order
    # Compare the strings
